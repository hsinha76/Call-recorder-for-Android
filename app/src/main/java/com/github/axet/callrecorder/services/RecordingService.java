...
public class RecordingService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    void startRecording() {
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(RecordingService.this);
        builder1.setMessage("Start voice recording?");
        ...
        alert11.getWindow().setType(WindowManager.LayoutParams.TYPE_TOAST);
